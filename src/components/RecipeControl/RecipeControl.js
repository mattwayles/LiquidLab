...
const RecipeControl = (props) => {
    ...
    return (
        <div className={classes.RecipeControl}>
            ...
            {parseInt(props.display.ven.row,10) === props.id && props.display.ven.display && venNotEmpty ? <InputOptions class={classes.InputOptionVen} row={props.id} name="ven" keyDown={props.keyDown} mouseDown={props.optionClick} active={props.cursor} options={props.list} /> : null}
            ...
            {parseInt(props.display.name.row,10) === props.id && props.display.name.display && nameNotEmpty ? <InputOptions class={classes.InputOptionFlavor} row={props.id} name="name" keyDown={props.keyDown} mouseDown={props.optionClick} active={props.cursor} options={props.list} /> : null}
