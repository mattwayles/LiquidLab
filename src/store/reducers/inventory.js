...
const reducer = (state = initialState, action) => {
    switch (action.type) {
        case actionTypes.SAVE_INVENTORY_DATA_REDUX: return updateObject(state, { base: action.base, flavors: action.flavors });
        ...
        case actionTypes.GET_USER_INVENTORY_SUCCESS: return updateObject(state, { base: action.base ? action.base : [], flavors: action.flavors ? action.flavors : [], loading: false });
